...
//        return MFScrollAnimationCurveParameters(baseCurve: nil, speedSmoothing: 0.00, baseMsPerStepMin: 90, baseMsPerStep: 140, dragExponent: 1.05, dragCoefficient: 15, stopSpeed: 30, sendGestureScrolls: false, sendMomentumScrolls: false)
        ...
        ///     - TODO: Play around with `baseMsPerStepMin` and find optimal value for all the animation curves. highInertia could also benefit.
...
//        return MFScrollAnimationCurveParameters(baseCurve: nil, speedSmoothing: 0.15, baseMsPerStep: 175, dragExponent: 0.9, dragCoefficient: 25, stopSpeed: 30, sendGestureScrolls: false, sendMomentumScrolls: false)
    ...
    case kMFScrollAnimationCurveNameHighInertia:
        ...
        /// Update: Turned speedSmoothing off rn for more responsive/predictable feel. 
