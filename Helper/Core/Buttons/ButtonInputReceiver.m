...
static CGEventRef eventTapCallback(CGEventTapProxy proxy, CGEventType type, CGEventRef event, void *userInfo) {
    ...
    if (iohidDevice == NULL) {
        DDLogDebug(@"Couldn't determine sending device for event. It might have been artificially generated by another app. Letting the event pass through. Event description: %@", [NSEvent eventWithCGEvent:event]);
        return event;
    }
