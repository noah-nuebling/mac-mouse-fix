...
+ (void)enableKeyCaptureMode {
    ...
    if (_keyCaptureEventTap == nil) {
        _keyCaptureEventTap = [Utility_Transformation createEventTapWithLocation:kCGSessionEventTap mask:CGEventMaskBit(kCGEventKeyDown) option:kCGEventTapOptionDefault placement:kCGTailAppendEventTap callback:keyCaptureModeCallback];
    }
