...
static void setStreamToCurrentInstallLoc() {
    ...
    NSURL *mainApp = Objects.mainAppBundle.bundleURL;
    ...
    if (mainApp != nil) {
        ...
        NSLog(@"Set file monitoring to: %@ App location accoring to NSWorkspace: %@", enclosing.path, [NSWorkspace.sharedWorkspace URLForApplicationWithBundleIdentifier:kMFBundleIDApp].path);
    }
}
