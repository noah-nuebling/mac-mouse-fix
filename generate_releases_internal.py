...
download_folder                 = "generate_releases_downloads"                     # This is were we download old app versions to, and then unzip them. We want to delete this on exit. (Update: [Mar 2025] also using this to store other temporary data now)
