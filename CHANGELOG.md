...
- Now supports scroll-to-zoom. When you hold command while scrolling, Mac Mouse Fix will let the computer think that you're performing a pinch to zoom gesture on a trackpad. 
