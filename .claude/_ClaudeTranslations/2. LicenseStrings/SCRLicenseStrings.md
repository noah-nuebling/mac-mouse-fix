...
Prompt
    Main prompt
        Hi there Claude! Please use the CTXLicenseStrings.md doc to translate the license strings into Polish (pl)
    ...
    Review prompt (fresh chat)
        ...
        Let's review the Polish (pl) translations.
        ...
        Please compare the translations and analyze them for any mistakes or other improvements. Please explain the problems and differences to me to help me gain an intuitive understanding. (I don't speak Polish)
