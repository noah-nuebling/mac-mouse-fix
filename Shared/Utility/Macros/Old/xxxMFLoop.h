...
#if 0 /** [Mar 4 2026] All this stuff below is from my `autistic-c-macro-obsession` phase and is not useful enough to warrant the complexity.*/
...
#import <Foundation/Foundation.h>
    ...
    ///            Iterate [2,1,0]:
    ///                 Macro: `for range(i, 0,3,-1)`                       (Same as forward iteration, just with step=-1)
    ...
    ///                  > Corresponds to                    `for range(i, -2, 1, arrayCount-1)`
