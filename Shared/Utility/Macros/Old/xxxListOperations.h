...
#if 0 /** [Mar 4 2026] All this stuff below comes from my `autistic-c-macro-obsession` phase and is not useful enough to warrant the complexity. */
...
#import "MFLoop.h"
    ...
    ({                                                                          \
        ...
        for range(__i, (lower), (upper), (step)) {                                  \
