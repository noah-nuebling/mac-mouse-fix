...
NSString *getMFRedirectionServiceLink(NSString *_Nonnull target, NSString *_Nullable message, NSDictionary *_Nullable otherQueryParamsDict) {
    ...
    ///  Usage example:
    ///     ```
    ///     getMFRedirectionServiceLink(@"mailto-noah", @"Is Redirecting...", @{
    ///                                                     @"subject": @"Cool Beans",
    ///                                                     @"body":    @"aaaaa",
    ///                                                 });
    ///     ```
    ...
    ///     ```
    ///     https://noah-nuebling.github.io/redirection-service?message=Is%20Redirecting...&target=mailto-noah&body=aaaaa&subject=Cool%20Beans
    ///     ```
    ...
    /// Construct result
    NSString *result = stringf(@"https://noah-nuebling.github.io/redirection-service?message=%@&target=%@%@", message, target, otherQueryParamsStr);
