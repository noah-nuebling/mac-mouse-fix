...
//      General note on my use of CocoaLumberjack: I plan on not using the verbose channel for logging at all because it doesn't make sense for me to differentiate it from the debug channel. I probably won't use Error and Warn either because it's too much work to migrate all my old NSLogStatements into all these different categories. So I'll just use Info and Debug channels. At least for now.
