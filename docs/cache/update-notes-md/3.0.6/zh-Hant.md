...
如果你發現任何尚未支援的應用程式，請在[功能請求](http://redirect.macmousefix.com/?target=mmf-feedback-feature-request)中告訴我。
...
希望問題現在已經解決！如果沒有，請在[錯誤報告](http://redirect.macmousefix.com/?target=mmf-feedback-bug-report)或通過[電子郵件](http://redirect.macmousefix.com/?target=mailto-noah)告訴我。
