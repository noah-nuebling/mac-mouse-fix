...
Nicméně **všechny jazyky stále potřebují práci**, protože spousta nového obsahu byla zpřístupněna k překladu.

Proto:

> [!TIP]
> Podívej se na nový [Průvodce překládáním](https://redirect.macmousefix.com/?target=mmf-localization-contribution), pokud bys chtěl pomoci přinést skvělé překlady uživatelům Mac Mouse Fix po celém světě! 🌎

### Další změny

Při používání Mac Mouse Fix v angličtině se toho moc nezměnilo, ale několik věcí bylo aktualizováno v uživatelském rozhraní a spousta se změnila pod kapotou, aby se zlepšily překlady:
...
- Nahrazena knihovna pro parsování Markdown, aby se opravily některé chyby formátování v čínštině a korejštině.
...
Předchozí verzi Mac Mouse Fix najdeš zde: [3.0.8](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.8)
...
3. Aktualizace:
    ...
    - Změny:
        ...
        - Opravena chyba vykreslování Markdown, kde by odrážky seznamu měly podtržení, pokud by první věc po seznamu byl odkaz. To ovlivňovalo turečtinu na několika místech.

4. Aktualizace
    - Číslo buildu souboru MacMouseFixApp.zip: 24827
    - Datum [21. prosince 2025]
    - Změna: Přidány španělské překlady od @manghidev