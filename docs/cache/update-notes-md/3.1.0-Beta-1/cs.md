...
- [@Dro9an](https://github.com/Dro9an) a [@jihao](https://github.com/jihao): 🇨🇳 čínský překlad [webových stránek](https://macmousefix.com/zh-Hans)
...
3. Aktualizace:
    ...
    - Změny:
        ...
        - Opraven problém s vykreslováním Markdown, kde by odrážky seznamu měly podtržení, pokud byla první věc po seznamu odkaz. To ovlivnilo turečtinu na několika místech.
...
5. Aktualizace
    - Číslo buildu souboru MacMouseFixApp.zip: 24828
