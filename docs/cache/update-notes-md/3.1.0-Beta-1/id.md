...
- [@hasanbeder](https://github.com/hasanbeder): 🇹🇷 Terjemahan Turki
...
> [!TIP]
> Lihat [Panduan Terjemahan](https://redirect.macmousefix.com/?target=mmf-localization-contribution) yang baru jika Anda ingin membantu menghadirkan terjemahan yang hebat kepada pengguna Mac Mouse Fix di seluruh dunia!
...
- Tata letak teks yang lebih baik untuk bahasa Mandarin dan Korea, yang memiliki masalah pembungkusan teks di beberapa notifikasi popup kecil.
- Mengganti pustaka parsing Markdown untuk memperbaiki beberapa bug pemformatan dalam bahasa Mandarin dan Korea.
- Banyak lagi perubahan dan perbaikan di balik layar.
