...
- Descargo de responsabilidad: Uso mucho la palabra 'fácil'. Los flujos de trabajo son fáciles, ¡pero pensar en excelentes traducciones sigue siendo, por supuesto, un trabajo duro y respetable! Simplemente hay menos barreras en el camino ahora.




Ya se han proporcionado generosamente nuevas traducciones por las siguientes personas:

- **Eduardo Rodrigues** y [@denini08](https://github.com/denini08): 🇧🇷 Traducciones al portugués brasileño
...
> [!TIP]
> ¡Consulta la nueva [Guía de Traducción](https://redirect.macmousefix.com/?target=mmf-localization-contribution) si te gustaría ayudar a llevar excelentes traducciones a los usuarios de Mac Mouse Fix en todo el mundo! 🌎

### Otros cambios

Al usar Mac Mouse Fix en inglés, no ha cambiado mucho, pero se han actualizado algunas cosas en la interfaz de usuario, y mucho ha cambiado internamente, para ayudar a mejorar las traducciones:
...
- Se ha ajustado el ancho de las vistas y ventanas emergentes para verse genial en varios idiomas.
...
3. Actualización:
    ...
    - Cambios:
        ...
        - Se hicieron los márgenes horizontales en la pestaña de Desplazamiento ligeramente más estrechos para funcionar mejor con algunas cadenas de interfaz de usuario turcas más amplias.
...
7. Actualización
    - Número de compilación del archivo MacMouseFixApp.zip: 24830
    - Fecha [1 de enero de 2026]
    - Cambios:
        - Se actualizaron las traducciones al portugués brasileño por [@denini08](https://github.com/denini08)