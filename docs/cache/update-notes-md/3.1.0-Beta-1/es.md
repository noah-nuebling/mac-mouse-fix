Mac Mouse Fix **3.1.0 Beta 1** trae un nuevo y excelente sistema de traducción, en el que se ha estado trabajando durante un tiempo.\
...
- El sistema está configurado para ser muy fácil de mantener, así que a medida que Mac Mouse Fix evoluciona y se añaden nuevas pantallas o textos, todo se actualizará automáticamente.
...
> [!TIP]
> ¡Echa un vistazo a la nueva [Guía de Traducción](https://redirect.macmousefix.com/?target=mmf-localization-contribution) si te gustaría ayudar a llevar excelentes traducciones a los usuarios de Mac Mouse Fix en todo el mundo! 🌎
...
1. Actualización:
    ...
    - Cambio: Se añadieron traducciones al ruso por Vyacheslav
...
3. Actualización:
    ...
    - Fecha: [15 de diciembre de 2025]
    - Cambios:
        - Se añadieron traducciones al turco por Eren.
        ...
        - Se corrigió un problema de renderizado de Markdown donde las viñetas de lista tendrían subrayado si lo primero después de la lista era un enlace. Esto afectaba al turco en algunos lugares.

4. Actualización
    - Número de compilación del archivo MacMouseFixApp.zip: 24827
    - Fecha: [21 de diciembre de 2025]
    - Cambio: Se añadieron traducciones al español por @manghidev