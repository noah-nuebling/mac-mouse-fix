...
- Acum este super ușor să contribui cu traduceri de înaltă calitate pentru Mac Mouse Fix, fără a fi necesare cunoștințe tehnice.
...
- [@Dro9an](https://github.com/Dro9an) și [@jihao](https://github.com/jihao): 🇨🇳 Traducerea în chineză a [site-ului web](https://macmousefix.com/zh-Hans)
- [@manghidev](https://github.com/manghidev): 🇪🇸 Traduceri în spaniolă
- **Jakub**: 🇵🇱 Traduceri în poloneză ale [site-ului web](https://macmousefix.com/pl)
- [ETMH](https://t.me/sos_soon_ok): 🇷🇺 Traduceri în rusă
...
- Înlocuită biblioteca de parsare Markdown pentru a remedia unele erori de formatare în chineză și coreeană.
...
Poți găsi versiunea anterioară a Mac Mouse Fix aici: [3.0.8](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.8)

---

Actualizări:
(Actualizez traducerile fără a crea o nouă versiune GitHub de fiecare dată.)

1. Actualizare:
    - Numărul de build al fișierului MacMouseFixApp.zip: 24814
    - Data: [8 decembrie 2025]
    - Modificare: Adăugate traduceri în rusă de Vyacheslav

2. Actualizare:
    - Numărul de build al fișierului MacMouseFixApp.zip: 24815
    - Data: [15 decembrie 2025]
    - Modificare: Actualizate traduceri în cehă de Petr
...
3. Actualizare:
    ...
    - Modificări:
        ...
        - Marjele orizontale de pe fila Derulare au fost făcute puțin mai înguste pentru a funcționa mai bine cu unele șiruri de text turcești mai largi.
...
5. Actualizare
    - Numărul de build al fișierului MacMouseFixApp.zip: 24828
    - Data [27 decembrie 2025]
    - Modificări:
        - Actualizate traduceri în rusă oferite de ETMH
        - Remediat un bug de aspect pe fila Butoane care a apărut cu traducerile în rusă.