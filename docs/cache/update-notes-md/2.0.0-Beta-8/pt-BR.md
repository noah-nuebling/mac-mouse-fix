...
- Revertidas as alterações no processamento de entrada introduzidas no Beta 6, pois causavam problemas onde o ponteiro do mouse ficava preso no lugar. Veja este [Issue no Github](https://github.com/noah-nuebling/mac-mouse-fix/issues/93) para mais informações.
- Adicionado um link de ajuda na tela 'Conceder Acesso de Acessibilidade ao Mac Mouse Fix Helper'
...
O [GitHub Discussions](https://github.com/noah-nuebling/mac-mouse-fix/discussions/82) é um ótimo lugar para compartilhar quaisquer outros pensamentos.
