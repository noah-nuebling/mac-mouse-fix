...
對於 3.0.1 和 3.0.2 中滾動相關的問題，我深表歉意。我大大低估了這些改動會帶來的問題，而且我在解決這些問題時反應遲緩。我會盡最大努力從這次經歷中吸取教訓，在未來對此類改動更加謹慎。我也願意為受影響的用戶提供退款。如果你有興趣，請點擊[這裡](https://redirect.macmousefix.com/?target=mmf-apply-for-refund)。

### 更智能的更新機制

這些改進來自 Mac Mouse Fix [2.2.4](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.4) 和 [2.2.5](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.5)。查看它們的發布說明以了解詳情。以下是摘要：
