...
Pentru versiunea originală în engleză, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.1.0">click aici</a>.
</td></table>

<table></table>

# 2.1.0
***Data lansării:** 9 ian. 2022*

<br>

Verifică și **lucrurile interesante** introduse în [Mac Mouse Fix 2](https://redirect.macmousefix.com/?target=mmf-release&tag=2.0.0&locale=ro)!
