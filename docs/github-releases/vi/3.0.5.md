...
**Bỏ qua bản cập nhật này** để tiếp tục sử dụng Mac Mouse Fix 2. Tải phiên bản mới nhất của Mac Mouse Fix 2 [tại đây](https://redirect.macmousefix.com/?target=mmf2-latest&locale=vi).
- **Mac Mouse Fix 3**\
...
Đồng thời hãy xem qua phiên bản trước đó [**3.0.4**](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.4&locale=vi).
