...
For den originale engelske versjonen, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.0-Beta-6">klikk her</a>.
</td></table>

<table></table>

# 3.0.0 Beta 6
***Utgivelsesdato:** 16. des. 2022*

<br>

Sjekk også ut de **kule endringene** introdusert i [3.0.0 Beta 5](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.0-Beta-5&locale=nb)!
