...
För den engelska originalversionen, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.0-Beta-2">klicka här</a>.
</td></table>

<table></table>

# 3.0.0 Beta 2
***Utgivningsdatum:** 14 sep. 2022*

<br>

Kolla även in de **coola grejerna** som introducerades i [3.0.0 Beta 1](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.0-Beta-1.1&locale=sv)!
