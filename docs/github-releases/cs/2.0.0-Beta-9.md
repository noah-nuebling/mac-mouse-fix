...
Pro původní anglickou verzi <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.0.0-Beta-9">klikněte zde</a>.
</td></table>
...
Tato beta verze obsahuje opravy chyb a vylepšení pro používání v prostředí s více uživateli. \
Více informací najdete v tomto [Github Issue](https://github.com/noah-nuebling/mac-mouse-fix/issues/93).
