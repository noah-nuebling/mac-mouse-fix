...
Pro původní anglickou verzi <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.0-Beta-2">klikněte zde</a>.
</td></table>

<table></table>

# 3.0.0 Beta 2
***Datum vydání:** 14. 9. 2022*

<br>

Podívejte se také na **skvělé novinky** představené ve verzi [3.0.0 Beta 1](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.0-Beta-1.1&locale=cs)!
