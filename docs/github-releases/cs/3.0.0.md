...
Pokud jsi mi už koupil milkshake přes PayPal – děkuji! Klikni [sem](https://redirect.macmousefix.com/?locale=cs&target=mmf-apply-for-milkshake-license) a získej **licenci zdarma**.
...
1. [Stáhni si MMF 2](https://redirect.macmousefix.com/?locale=cs&target=mmf2-latest) znovu.
...
Zobraz poznámky k vydání [3.0.0 Beta 7](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.0-Beta-7&locale=cs) a předchozích beta verzí, abys zjistil vše, co se změnilo.
