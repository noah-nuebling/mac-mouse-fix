...
要查看原始的 GitHub 發布版本（英文），請<a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.2">點擊這裡</a>。
</td></table>
...
**上一個版本** [**2.2.1**](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.1) 新增了對 **macOS 13 Ventura** 的支援以及更多功能！
