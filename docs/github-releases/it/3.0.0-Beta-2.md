...
Per la versione originale in inglese, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.0-Beta-2">clicca qui</a>.
</td></table>

<table></table>

# 3.0.0 Beta 2
***Data di rilascio:** 14 set 2022*

<br>

Dai anche un'occhiata alle **novità interessanti** introdotte in [3.0.0 Beta 1](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.0-Beta-1.1&locale=it)!
