...
Per veure el GitHub Release original (en anglès), <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.1-Beta-3">feu clic aquí</a>.
</td></table>

<table></table>

# 2.2.1 Beta 3
***Data de llançament:** 6 de set. 2022*

<br>

Mac Mouse Fix __2.2.1 Beta 3__ recupera la compatibilitat amb versions anteriors de macOS i més.
