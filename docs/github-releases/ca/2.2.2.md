...
Per veure el GitHub Release original (en anglès), <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.2">feu clic aquí</a>.
</td></table>
...
La **versió anterior** [**2.2.1**](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.1) va afegir suport per a **macOS 13 Ventura** i més!
