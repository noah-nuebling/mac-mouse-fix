...
Per veure el GitHub Release original (en anglès), <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.1.0">feu clic aquí</a>.
</td></table>
...
També fes un cop d'ull a les **novetats** introduïdes a [Mac Mouse Fix 2](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.0.0)!
