...
Per veure el GitHub Release original (en anglès), <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.0-Beta-3">feu clic aquí</a>.
</td></table>

<table></table>

# 3.0.0 Beta 3
***Data de llançament:** 15 de set. 2022*

<br>

També consulteu els **canvis** a [3.0.0 Beta 2](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.0-Beta-2)!
