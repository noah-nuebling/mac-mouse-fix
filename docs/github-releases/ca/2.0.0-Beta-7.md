...
Per veure el GitHub Release original (en anglès), <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.0.0-Beta-7">feu clic aquí</a>.
</td></table>
...
- S'ha signat l'aplicació amb un nou certificat. L'antic certificat va ser revocat, cosa que va provocar problemes. Vegeu [aquest problema a GitHub](https://github.com/noah-nuebling/mac-mouse-fix/issues/95).
- Aquesta i futures versions beta de Mac Mouse Fix s'executaran de manera nativa en Macs M1.
- Petites correccions d'errors i millores.
