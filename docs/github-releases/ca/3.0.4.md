...
Per veure la versió original en anglès, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.4">feu clic aquí</a>.
</td></table>

<table></table>

# 3.0.4
***Data de llançament:** 7 de juny 2025*
...
També pots consultar la versió anterior [**3.0.3**](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.3&locale=ca).
