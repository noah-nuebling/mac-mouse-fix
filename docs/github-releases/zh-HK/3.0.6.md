...
希望問題現在已經解決！如果沒有，請在[錯誤報告](http://redirect.macmousefix.com/?target=mmf-feedback-bug-report&locale=zh-HK)或通過[電郵](http://redirect.macmousefix.com/?target=mailto-noah&locale=zh-HK)告訴我。
