...
# 3.0.8
***Data de Lançamento:** 12 de set. de 2025*
...
Confira também as novidades da versão anterior [3.0.7](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.7&locale=pt-BR).
