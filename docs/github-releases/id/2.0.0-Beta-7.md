...
Untuk versi asli dalam bahasa Inggris, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.0.0-Beta-7">klik di sini</a>.
</td></table>
...
- Aplikasi ditandatangani dengan sertifikat baru. Sertifikat lama dicabut yang menyebabkan masalah. Lihat [GitHub Issue ini](https://github.com/noah-nuebling/mac-mouse-fix/issues/95).
- Rilis Beta Mac Mouse Fix ini dan selanjutnya akan berjalan secara native di Mac M1.
...
- Bagikan pendapat dan ide perbaikanmu tentang teks UI baru.\
   Ada cukup banyak teks baru di aplikasi. Aku ingin teks tersebut mencapai keseimbangan yang bagus antara kejelasan dan kesederhanaan. Jika ada yang menurutmu kurang optimal, beri tahu aku!
