...
לגרסה המקורית באנגלית, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/3.0.0-Beta-2">לחץ כאן</a>.
</td></table>

<table></table>

# 3.0.0 Beta 2
***תאריך שחרור:** 14 בספט׳ 2022*

<br>

כדאי גם לבדוק את **הדברים המגניבים** שהוצגו ב-[3.0.0 Beta 1](https://redirect.macmousefix.com/?target=mmf-release&tag=3.0.0-Beta-1.1&locale=he)!
