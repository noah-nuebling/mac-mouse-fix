...
לגרסה המקורית באנגלית, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.2">לחץ כאן</a>.
</td></table>

<table></table>

# 2.2.2
***תאריך שחרור:** 23 באוק׳ 2022*

<br>

הגרסה **הקודמת** [**2.2.1**](https://redirect.macmousefix.com/?target=mmf-release&tag=2.2.1&locale=he) הוסיפה תמיכה ב-**macOS 13 Ventura** ועוד!
