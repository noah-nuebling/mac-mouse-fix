...
Estos cambios se trasladaron desde Mac Mouse Fix [2.2.4](https://redirect.macmousefix.com/?target=mmf-release&tag=2.2.4&locale=es) y [2.2.5](https://redirect.macmousefix.com/?target=mmf-release&tag=2.2.5&locale=es). Consulta sus notas de lanzamiento para conocer más sobre los detalles. Aquí hay un resumen:
