...
Pour la version originale en anglais, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.0.0-Beta-9">cliquez ici</a>.
</td></table>
...
### Changements dans la Beta 9

Cette version bêta comprend des corrections de bugs et des améliorations de qualité de vie lors de l'utilisation dans un environnement multi-utilisateurs. \
Voir cet [Issue Github](https://github.com/noah-nuebling/mac-mouse-fix/issues/93) pour plus d'informations.
...
- Décrivez vos impressions et expériences avec la nouvelle interface en général. Avez-vous trouvé quelque chose de déroutant ou avez-vous eu du mal à faire fonctionner l'application comme vous le souhaitez ? Faites-le moi savoir !
