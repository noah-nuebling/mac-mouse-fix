...
Pour la version originale en anglais, <a href="https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.1-Beta-2">cliquez ici</a>.
</td></table>
...
### Encore plus d'améliorations pour Ventura !
