...
def getpath_custom_string     (locale: str, strkey: str)          -> str:   return os.path.join(folder_custom_strings         , strkey      , locale    + '.txt') # Note: [Mar 2025] For other files, put all locales in the same folder, so we can compare them more easily.
def getpath_release_notes_md  (locale: str, tag_name: str)        -> str:   return os.path.join(folder_update_notes_markdown  , tag_name    , locale    + '.md')
