...
To contribute translations to Mac Mouse Fix:

1. Download the **Translation Files** of a language that you wish to work on.
    - You can find the download link for the **Translation Files** in the table below. 
...
2. The **Translation Files**, which are of type .xcloc, can be edited using Xcode. You can download Xcode [here](https://apps.apple.com/de/app/xcode/id497799835?l=en-GB&mt=12).
    - Xcode is Apples Software for professional Software Development. But don't worry, it has a nice user interface for editing translation files, and you don't have to know anything about programming or software development.
    - After downloading Xcode, double click one of the .xcloc files you downloaded to begin editing it.
    - Browse all the translatable files in the navigator on the left, then translate the text in the editor on the right
...
3. Once you're done translating the .xcloc files (the 'State' of all texts should be a green checkmark) you can then send the .xcloc file back to me by writing a comment below and attaching the .xcloc files
    - Alternatively, you can send me an email and include the .xcloc files.
    
If your translations are accepted into the project you will receive a mention in the next update notes and the Acknowledgments (if your contribution was more than 10 strings or sth?)    

And that's it. f you have any questions, please write a comment below - and thank you so much for your help in bringing Mac Mouse Fix to people around the world!
...
Mac Mouse Fix can be translated into different languages! 🌍
    
To contribute translations to Mac Mouse Fix:

## 1. Download **Translation Files**

Download the **Translation Files** for a language to begin translating it!
...
The **Translation Files**, which are of type .xcloc, can be edited using Xcode. \
You can download Xcode [here](https://apps.apple.com/de/app/xcode/id497799835?l=en-GB&mt=12).
...
Once you're done translating the .xcloc files (the 'State' of all texts should be a green checkmark) you can then send the .xcloc file back to me by writing a comment below and attaching the .xcloc files
- Alternatively, you can send me an email and include the .xcloc files.
...
And that's it. If you have any questions, please write a comment below - and thank you so much for your help in bringing Mac Mouse Fix to people around the world!
"""
