...
//        NSString *notifString = [NSString stringWithFormat:@"%@%@", capString, uncapString];
        ...
        attrNotifString = [attrNotifString attributedStringByAddingLinkWithURL:[NSURL URLWithString:@"https://redirect.macmousefix.com/?target=mmf-captured-buttons-guide"] forSubstring:linkString];
