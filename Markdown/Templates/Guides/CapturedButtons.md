...
### {{What does it mean for a button to be 'captured' by Mac Mouse Fix?||a||}}
...
### {{How do I know which buttons are captured by Mac Mouse Fix?||b||}}
...
### {{How to uncapture a mouse button?||c||}}
...
### {{What can I do to restore the original functionality of a button?||d||}}
...
#### {{How to use the original functionality of clicking the Middle Mouse Button without uncapturing it?||e||}}
