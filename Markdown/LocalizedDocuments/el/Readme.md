...
<div align="center">
    <table>
        ...
        <td><a href=https://redirect.macmousefix.com/?locale=el&target=mmf-help-and-feedback>Help&nbsp;&amp;&nbsp;Feedback</a></td> <!-- Note: Should probably use direct link instead of redirection-service: https://github.com/noah-nuebling/mac-mouse-fix/issues/new/choose -->
        <td><a href=https://redirect.macmousefix.com/?locale=el&target=mmf-releases>Releases</a></td> <!-- Note: Should probably use direct link instead of redirection-service: https://github.com/noah-nuebling/mac-mouse-fix/releases -->
...
- **Are there 'App-Specific Settings' or 'Profiles'?**
  ...
  I'm interested to hear *how you want to use these features*! Feel free to submit a [feature request](https://redirect.macmousefix.com/?locale=el&target=mmf-feedback-feature-request) – your input will help me make the features as great as possible!
...
- **What's the difference between Mac Mouse Fix 2 and 3?**
  ...
  **Features:** \
  Here's a [feature comparison](https://redirect.macmousefix.com/?locale=el&target=mmf-version-2-vs-3). I wrote it shortly after Mac Mouse Fix 3 released – so it may be slightly out of date. \
...
- **How many devices can I use my license on?**
  ...
  If you encounter problems activating your license, please [send me an email](https://redirect.macmousefix.com/?locale=el&target=mailto-noah). \
