...
Mac Mouse Fix **fanger opp musens skrollehjul som standard**, på samme måte som det [fanger opp museknapper](<../../Support/Guides/CapturedButtonsMMF3.md>).

**For å forhindre at rullehjulet fanger opp:**

1. Gå til fanen «Rulling» i Mac Mouse Fix
2. Slå av **alle** alternativer
- Hvis alternativet «Hastighet» er valgt, sett det til «macOS»
- Fjern alle oppføringer under «Tastaturmodifikatorer» ved å klikke på «x»-knappen ved siden av hver modifikator

Etter dette skal du se en melding som indikerer at skrollehjulet ikke lenger fanges opp.

**Hva skjer når rullehjulet *ikke lenger* blir fanget opp?**

Mac Mouse Fix vil da ignorere rullehjulet ditt fullstendig – det vil ikke bruke prosessorkraft eller batterilading under rulling, eller forstyrre på noen måte. Dette gir deg full frihet til å bruke andre apper som [MOS](https://mos.caldis.me/) til å håndtere rullehjulet ditt.

## Se også

- [Fanget museknapper](<../../Support/Guides/CapturedButtonsMMF3.md>)

*(Redigert med utmerket hjelp av Claude 3.5 Sonnet)*
