...
Dette dokumentet er `95%` oversatt til `🇳🇴 Norsk bokmål`
[Hjelp med å oversette](https://redirect.macmousefix.com/?locale=nb&target=mmf-localization-contribution)</td></table>
...
Stor takk til alle som bruker Mac Mouse Fix og gir tilbakemeldinger. Det er fantastisk og svært motiverende å se at så mange liker og engasjerer seg i noe jeg har laget.

Jeg vil spesielt takke personene og prosjektene som er navngitt i dette dokumentet.

<a name="translations"></a> 
## 🌏 Oversettelser

Takk for at du har gjort Mac Mouse Fix tilgjengelig for folk over hele verden!

- 🇨🇳 Kinesiske oversettelser av
...
- 🇰🇷 Koreanske oversettelser av [@jeongtae](https://github.com/jeongtae)
- 🇻🇳 Vietnamesiske oversettelser av
...
- 🇨🇿 Tsjekkiske oversettelser av [Petr Pavlík](http://www.petrpavlik.com)
- 🇷🇺 Russiske oversettelser av [ETMH](https://t.me/sos_soon_ok)
- 🇪🇸 Spanske oversettelser av [@manghidev](https://github.com/manghidev)
- 🇵🇱 Polske oversettelser av **Jakub** (Nettstedoversettelse)
...
Tusen takk til alle som spanderte milkshake på meg, og til alle **48400+** som kjøpte Mac Mouse Fix.
...
**Stor takk** til [alle](https://github.com/sponsors/noah-nuebling#sponsors) som sponser meg på GitHub! Forhåpentligvis kan jeg få tak i den milkshakefabrikken en dag takket være dere. :)

<a name="paypal-donations"></a> 
### ✨ PayPal-donasjoner

Mange generøse mennesker kjøpte meg milkshakes på PayPal da Mac Mouse Fix fortsatt var helt gratis.

Hvis du er blant dem, klikk [her](https://redirect.macmousefix.com/?locale=nb&target=mmf-apply-for-milkshake-license) for å motta en **gratis lisens**!
<!-- It's truly incredibly helpful to have some predictable monthly income. -->

<a name="other-software"></a> 
## 👾 Annen programvare

**Programvare** som inspirerte Mac Mouse Fix:

- [SteerMouse](https://plentycom.jp/en/steermouse/index.html) - Banebrytende museprogramvare for Mac, som inspirerte mange funksjoner. Det var øyeblikk da jeg tenkte «dette er sannsynligvis ikke mulig», men så så jeg «åh, SteerMouse gjør det», og tre år senere fant jeg ut hvordan jeg skulle implementere det også.

- [Calftrail Touch](https://github.com/calftrail/Touch) - Grunnlaget for «reverse engineering»-arbeidet som driver Mac Mouse Fix' klasseledende og enestående styreflatesimulering!

- [MOS](https://mos.caldis.me/) - Mac Mouse Fix' alternativ «High Scroll-Smoothness», implementeringen av «App-Specific Settings» og mer ble inspirert av MOS.

- [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) - Jeg kopierte koden for en tidlig implementering av funksjonen «Gå tilbake/frem én side i Safari og andre apper», og ledet meg også til å oppdage Calftrail Touch-prosjektet.

- [Gifski](https://github.com/sindresorhus/Gifski) - Inspirerte designet og innholdet i [Readme.md](Readme.md) for Mac Mouse Fix i stor grad.
- [Vue Issue Helper](https://new-issue.vuejs.org/) - Grunnlaget for design og teknisk implementering av [Mac Mouse Fix Feedback Assistant](https://noah-nuebling.github.io/mac-mouse-fix-feedback-assistant/).
