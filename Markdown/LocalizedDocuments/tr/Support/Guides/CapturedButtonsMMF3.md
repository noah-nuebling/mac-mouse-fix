...
| Düğme | Orijinal Fonksiyon | Mac Mouse Fix üzerindeki Eylem |
|----------|-----------------------------------|-------------------------|
...
| Orta Düğme | Blender ve diğer 3D uygulamalarda yörüngede dönme | 'Kaydır ve Yönlendir'<br> (Herhangi bir düğmeye **tıkla ve kaydır** eylemi ile eklenebilir) |
...
Umarım bu doküman kafanızdaki soru işaretlerini kaldırmıştır.</td>
<td>
