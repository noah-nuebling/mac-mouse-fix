...
Tài liệu này đã được dịch `35%` sang `🇻🇳 Tiếng Việt`
...
<div align="center">
    ...
    <h1>Mac Mouse Fix</h1>  
    <p>Biến chuột $10 của bạn tốt hơn Apple Trackpad</p>
</div>
...
<div align="center">
    <table>
        ...
        <td><a href=https://redirect.macmousefix.com/?locale=vi&target=mmf-help-and-feedback>Hỗ trợ&nbsp;&amp;&nbsp;Phản hồi</a></td> <!-- Note: Should probably use direct link instead of redirection-service: https://github.com/noah-nuebling/mac-mouse-fix/issues/new/choose -->
        <td><a href=https://redirect.macmousefix.com/?locale=vi&target=mmf-releases>Phát hành</a></td> <!-- Note: Should probably use direct link instead of redirection-service: https://github.com/noah-nuebling/mac-mouse-fix/releases -->
        <td><a href="Acknowledgements.md">Công nhận</a></td>
    </table>
    <img src="https://img.shields.io/github/downloads/noah-nuebling/mac-mouse-fix/total?color=25c65f&label=Tải xuống">
</div>
...
Mac Mouse Fix là ứng dụng làm cho chuột của bạn xịn hơn.

Tôi muốn Mac Mouse Fix thành trình điều khiển chuột tốt nhất *mọi thời đại*! Một số tính năng vẫn còn thiếu lúc này, nhưng tôi nghĩ nó đã **biến chuột thông thường thành thiết bị đầu vào tốt nhất cho Macs** theo cách nào đó. Ở cùng mức hoặc thậm chí hay hơn Apple Trackpad hoặc chuột Logitech MX Master. 

Nếu bạn cần nhiều thông tin hơn về Mac Mouse Fix đã nâng cấp chuột của bạn, truy cập [website](https://macmousefix.com/).
...
Xem [website](https://macmousefix.com/#trackpad) về tổng quan những tính năng của Mac Mouse Fix, bao gồm cả video demo!

Cụ thể hơn nữa, xem tại [Phát hành](https://github.com/noah-nuebling/mac-mouse-fix/releases).
...
Tải phiên bản mới nhất của Mac Mouse Fix tại [website](https://macmousefix.com/).

Bạn cũng có thể cài thông qua [Homebrew](https://brew.sh/)! Chỉ cần gõ lệnh sau vào terminal:

```bash
brew install mac-mouse-fix
```

Bạn có thể tải phiên bản cũ hơn của Mac Mouse Fix tại [Phát hành](https://github.com/noah-nuebling/mac-mouse-fix/releases).


<a name="macos-compatibility"></a>
## Tương thích macOS

Phiên bản mới nhất của Mac Mouse Fix dùng cho các phiên bản **macOS 11 Big Sur** và sau đó.

Nếu bạn đang sử dụng macOS **10.15 Catalina**, macOS **10.14 Mojave**, hoặc macOS **10.13 High Sierra**, bạn có thể dùng[bản mới nhất của Mac Mouse Fix 2](https://redirect.macmousefix.com/?locale=vi&target=mmf2-latest). Mac Mouse Fix 3.0.0 và sau đó có thể hoạt động nhưng sẽ có vài lỗi về hiển thị hoặc một số tính năng hoạt động không đúng.
    
Nếu bạn đang sử dụng macOS **10.12 Sierra**, hoặc **10.11 El Capitan**, bạn có thể dùng Mac Mouse Fix [2.2.0](https://github.com/noah-nuebling/mac-mouse-fix/releases/tag/2.2.0) hoặc thấp hơn.

<a name="pricing"></a> 
## Giá

Coi taij [website](https://macmousefix.com/#price) để biết tổng quan giá cho Mac Mouse Fix 3.<br>

Mac Mouse Fix 2 và thấp hơn sẽ được miễn phí mãi mãi.

<a name="uninstallation"></a> 
## Gỡ cài đặt

Gỡ cài đặt Mac Mouse Fix bằng cách đơn giản là chuyển ứng dụng vô trong thùng rác.

Tuy nhiên, sẽ có nhiều tệp tin vẫn còn ở trong hệ thống. Để xoá bỏ chúng, tôi đề xuất bạn xài ứng dụng tuyệt vời này [AppCleaner by FreeMacSoft](https://freemacsoft.net/appcleaner/).

Ở macOS, bạn không thể tự tay xoá hết những tệp tin đó. Đó là lý do tôi xuyên bạn nên xài những ứng dụng khư AppCleaner.

<a name="what-people-say"></a> 
## Điều mọi người nói

Cám ơn rất nhiều tới mọi người đã chia sẻ về niềm vui của họ về Mac Mouse Fix!<br>
Trên [website](https://macmousefix.com/) bạn có thể tìm thấy rất nhiều người nói tốt về ứng dụng.
