...
Tài liệu này đã được dịch `69%` sang `🇻🇳 Tiếng Việt`
...
<img height=200 src="../../../../..//Markdown/Media/Autogenerated/vi/CapturedButtons0.jpg">"
...
<img width=600  src="../../../../..//Markdown/Media/Autogenerated/vi/CapturedButtons1.jpg">"
...
<img width=600  src="../../../../..//Markdown/Media/Autogenerated/vi/CapturedButtons2.jpg">"
...
| Button | Chức năng gốc | Hành động trong Mac Mouse Fix |
|----------|-----------------------------------|-------------------------|
| Nút chuột giữa | Mở đường dẫn trên trình duyệt | 'Nhấn nút giữa'<br>(có thể được gán cho **đang nhấn** nút) |
| Nút chuột giữa | Dán văn bản trong terminal | 'Nhấn nút giữa'<br>(có thể được gán cho **đang nhấn** nút) |
| Nút thứ 4 / nút thứ 5 | Quay về / đi tới trong Chrome và những ứng dụng khác | 'Quay về' / 'Đi tới' <br>(có thể được gán cho **đang nhấn** nút) |
| Nút chuột giữa | Orbit around objects in Blender (and other 3D apps) | 'Scroll & Navigate'<br>(Can be assigned to **clicking and dragging** a button) |
