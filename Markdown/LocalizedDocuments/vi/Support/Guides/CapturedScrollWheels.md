...
Tài liệu này đã được dịch `73%` sang `🇻🇳 Tiếng Việt`
...
- [Đã bắt được nút nhấn](<../../Support/Guides/CapturedButtonsMMF3.md>)
...
Tôi mong hướng dẫn có mọi thứ bạn cần!</td>
<td>

Bạn vẫn có câu hỏi? Nhấn [tại đây](https://redirect.macmousefix.com/?locale=vi&target=mmf-support-still-have-questions).</td>
</table>
