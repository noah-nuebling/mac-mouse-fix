...
<div align="center">
    <table>
        ...
        <td><a href=https://redirect.macmousefix.com/?locale=cs&target=mmf-releases>Releases</a></td> <!-- Note: Should probably use direct link instead of redirection-service: https://github.com/noah-nuebling/mac-mouse-fix/releases -->
...
If you're on macOS **10.15 Catalina**, macOS **10.14 Mojave**, or macOS **10.13 High Sierra**, you can use the [latest version of Mac Mouse Fix 2](https://redirect.macmousefix.com/?locale=cs&target=mmf2-latest). Mac Mouse Fix 3.0.0 and later might still work on your machine, but they will have visual issues and some features might not work properly.
...
- **Are there 'App-Specific Settings' or 'Profiles'?**
  ...
  **Tip:** Until 'app-specific settings' arrive in Mac Mouse Fix 3, you can do this:
  ...
  I'm also interested to hear what your *use case* is. Feel free to submit a [feature request](https://redirect.macmousefix.com/?locale=cs&target=mmf-feedback-feature-request). Your input will help make the feature as good as possible once it arrives.
...
- **What's the difference between Mac Mouse Fix 2 and 3?**
  ...
  **Features:** <br>
  Here's a [feature comparison](https://redirect.macmousefix.com/?locale=cs&target=mmf-version-2-vs-3). I wrote it shortly after Mac Mouse Fix 3 released – so it may be slightly out of date. <br>
  You can also download Mac Mouse Fix [2](https://redirect.macmousefix.com/?locale=cs&target=mmf2-latest) and [3](https://macmousefix.com/) for free to evaluate them yourself!
...
- **How many devices can I use my license on?**
  ...
  If you encounter problems activating your license, you can [send me an email](https://redirect.macmousefix.com/?locale=cs&target=mailto-noah). <br>
