...
Ajuda para dúvidas e problemas sobre o Mac Mouse Fix.

## Perguntas

Respostas rápidas para dúvidas comuns [aqui](<../Readme.md#questions>).

## Guias

Sempre que possível, o Mac Mouse Fix tenta ser autoexplicativo. Mas para algumas coisas, uma explicação mais detalhada ajuda:

- [Rodas de Rolagem Capturadas](<../Support/Guides/CapturedScrollWheels.md>)
- [Botões do Mouse Capturados
](<../Support/Guides/CapturedButtonsMMF3.md>) (Mac Mouse Fix 3)
- [Captured Mouse Buttons](<../../../../Support/Guides/CapturedButtonsMMF2.md>) (Mac Mouse Fix 2) `🇬🇧 English`

### Guias antigos

Guias para versões mais antigas do Mac Mouse Fix ou do macOS.

- [Enabling Mac Mouse Fix](<../../../../Support/Guides/Old/Enabling.md>) `🇬🇧 English`
    - Para **macOS 13 Ventura** e **macOS 14 Sonoma**.
- [Granting Accessibility Access](<../../../../Support/Guides/Old/AccessibilityAccess.md>) `🇬🇧 English`
    - Para usuários do **Mac Mouse Fix 2.2.1** e anteriores, ou **macOS 10.14 Mojave** e anteriores.
- [Opening Mac Mouse Fix & Malware Messages](<../../../../Support/Guides/Old/Opening.md>) `🇬🇧 English`
    - Para **Mac Mouse Fix 2.2.3** e anteriores.
