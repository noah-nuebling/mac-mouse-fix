...
Любая кнопка, отображаемая в левой части вкладки 'Кнопки', захватывается Mac Mouse Fix.
...
|----------|-----------------------------------|-------------------------|
| Средняя кнопка мыши | Открыть ссылки в браузере в новой вкладке | 'Средний щелчок'<br>(Может быть назначен для **щелчка** кнопкой) |
| Средняя кнопка мыши | Вставить текст в терминал | 'Средний щелчок'<br>(Может быть назначен для **щелчка** кнопкой) |
