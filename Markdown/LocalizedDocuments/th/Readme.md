...
- **Are there 'App-Specific Settings' or 'Profiles'?**
  ...
  **Workaround** <br>
  ...
  I'm interested to hear what your *use case* is. Feel free to submit a [feature request](https://redirect.macmousefix.com/?locale=th&target=mmf-feedback-feature-request). Your input will help make the feature as good as possible once it arrives.
