...
この文章は `95%` `🇯🇵 日本語`に翻訳されました
[翻訳を手伝う](https://redirect.macmousefix.com/?locale=ja&target=mmf-localization-contribution)</td></table>
...
Mac Mouse Fixを利用し、フィードバックをくださるすべての方々に心より感謝申し上げます。自分が作ったものを、これほど多くの方々に楽しんでいただき、また積極的に関わっていただけることは、私にとって大きな喜びであり、開発の大きな励みになっています。

本ドキュメントに記載されている方々、およびプロジェクトには、特に深く感謝の意を表します。

<a name="translations"></a> 
## 🌏 翻訳

Mac Mouse Fixを世界中の人々に届けていただき、ありがとうございます！
...
- 🇰🇷 韓国語翻訳： [@jeongtae](https://github.com/jeongtae)
- 🇻🇳 ベトナム語翻訳：
...
- 🇨🇿 チェコ語翻訳： [Petr Pavlík](http://www.petrpavlik.com)
- 🇷🇺 ロシア語翻訳： [ETMH](https://t.me/sos_soon_ok)
- 🇪🇸 スペイン語翻訳： [@manghidev](https://github.com/manghidev)
- 🇵🇱 ポルトガル語翻訳： **Jakub** (Website translation)
...
ミルクシェイクをご馳走してくださった皆さん、そしてMac Mouse Fixを購入してくださった**48400+**名の方々に、心より感謝申し上げます。皆さんのおかげで、私は大好きなことに多くの時間を費やすことができています。
...
標準価格を大幅に上回るご支援をいただき、**とびきりのミルクシェイク**をご馳走してくださった方々です。（温かいメッセージを添えてくださった方もいらっしゃいます）
おかげさまで、*フルパワーで開発に励むことができます。*ありがとうございます！
...
GitHubでスポンサーとして活動を支えてくださっている[すべての方々](https://github.com/sponsors/noah-nuebling#sponsors)に、**心より感謝申し上げます**。皆さんのおかげで、いつか本当に「ミルクシェイク工場」を建てられる日が来るかもしれません！(^^)

<a name="paypal-donations"></a> 
### ✨ PayPalでの寄付

Mac Mouse Fixがまだ完全に無料だった頃、多くの方々がPayPalを通じてミルクシェイクをご馳走してくださいました。

寄付をしてくださった方は、[こちら](https://redirect.macmousefix.com/?locale=ja&target=mmf-apply-for-milkshake-license)をクリックして**無料ライセンス**をお受け取りください！
<!-- It's truly incredibly helpful to have some predictable monthly income. -->

<a name="other-software"></a> 
## 👾 その他のソフトウェア

Mac Mouse Fixの開発にあたってインスピレーションを受けた**ソフトウェア**：

[SteerMouse](https://plentycom.jp/en/steermouse/index.html) - Mac用マウスソフトウェアの先駆けであり、多くの機能のヒントとなりました。「これはおそらく不可能だろう」と諦めかけたとき、「あ、ステアマウスならできている」と気づかされ、その3年後にようやく自分でも実装方法を見つけ出すことができました。
[Calftrail Touch](https://github.com/calftrail/Touch) - Mac Mouse Fixの誇る最高クラスかつ唯一無二のトラックパッドシミュレーションを支える、「リバースエンジニアリング」の基礎となりました。
[MOS](https://mos.caldis.me/) - 「スクロールの滑らかさ：高」オプションや「アプリごとの設定」の実装などは、MOSからインスピレーションを受けています。
[SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) - Safariなどのアプリで「1ページ戻る/進む」機能の初期実装の際にコードを参考にさせていただきました。また、このプロジェクトを通じてCalftrail Touchを知るきっかけにもなりました。
[Gifski](https://github.com/sindresorhus/Gifski) - Mac Mouse Fixの[Readme.md](Readme.md)のデザインや構成において、多大な影響を受けました。
[Vue Issue Helper](https://new-issue.vuejs.org/) - [Mac Mouse Fix Feedback Assistant](https://noah-nuebling.github.io/mac-mouse-fix-feedback-assistant/)のデザインと技術的な実装のベースとなりました。
