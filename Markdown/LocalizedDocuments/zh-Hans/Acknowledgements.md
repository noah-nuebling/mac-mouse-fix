...
# 🙌 感恩
非常感谢每一位 Mac Mouse Fix 的用户以及向我提供反馈的你们。看到自己亲手创造的东西能被这么多人喜爱和使用，这让我备受鼓舞，也充满了动力。

在此，我特别想向本文档中提到的所有个人和项目表达最诚挚的谢意。

<a name="translations"></a> 
## 🌏 多语言翻译

感谢你们将 Mac Mouse Fix 推广给全球各地的用户！

- 🇨🇳 **中文翻译**：
    - [@groverlynn](https://github.com/groverlynn)
    - [@Dro9an](https://github.com/Dro9an)（网页翻译）
    - [@jihao](https://github.com/jihao)（网页翻译）
    - [@xianyu-wang](https://github.com/xianyu-wang)
    - [@djzhao627](https://github.com/djzhao627)
    - [@JunhangWu](https://github.com/JunhangWu)
- 🇰🇷 **韩语翻译**：[@jeongtae](https://github.com/jeongtae)
- 🇻🇳 **越南语翻译**：
...
- 🇨🇿 **捷克语翻译**：[Petr Pavlík](http://www.petrpavlik.com)
- 🇷🇺 **俄语翻译**：[ETMH](https://t.me/sos_soon_ok)
- 🇪🇸 **西班牙语翻译**：[@manghidev](https://github.com/manghidev)
- 🇵🇱 **波兰语翻译**：**Jakub**（网页翻译）
...
衷心感谢每一位请我喝奶昔的朋友，以及所有购买了 Mac Mouse Fix 的 **48500+** 位用户。
正是因为有了你们的支持，我才能投入大量时间去做我热爱的事情。

对于那些以高于标准价格购买 Mac Mouse Fix 来支持我的朋友，我在这里特别予以致谢：
...
这些朋友支付了远高于标准的价格，请我喝了一杯 **“超级无敌奶昔”**。（有些人还留下了寄语）感谢你们带来的*糖分冲击*！
...
**万分感谢**在 GitHub 上赞助我的[每一位朋友](https://github.com/sponsors/noah-nuebling#sponsors)！希望有朝一日在你们的支持下，我真的能开上一家奶昔工厂。:)

<a name="paypal-donations"></a> 
### ✨ PayPal 捐赠

在 Mac Mouse Fix 还是完全免费的阶段，许多慷慨的朋友通过 PayPal 请我喝了奶昔。

如果你也是其中一员，请点击[这里](https://redirect.macmousefix.com/?locale=zh-Hans&target=mmf-apply-for-milkshake-license)领取你的**免费授权许可**！
<!-- It's truly incredibly helpful to have some predictable monthly income. -->

<a name="other-software"></a> 
## 👾 其他软件

对 Mac Mouse Fix 产生启发或影响的**软件项目**：

- [SteerMouse](https://plentycom.jp/en/steermouse/index.html) —— Mac 鼠标控制软件的先驱，启发了本作的许多功能。曾几何时，我一度认为某些功能“可能无法实现”，但每当我看到“哦，SteerMouse 做到了”，我便重拾信心。三年后，我也终于摸索出了实现它们的方法。
- [Calftrail Touch](https://github.com/calftrail/Touch) —— 本作“逆向工程”工作的基石。正是基于此，Mac Mouse Fix 才得以实现业界领先且首创的触控板模拟功能！
- [MOS](https://mos.caldis.me/) —— Mac Mouse Fix 的“高滚动平滑度”选项、“特定应用设置”的实现等功能均深受 MOS 的启发。
- [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) —— 在实现“在 Safari 等应用中前进/后退”功能的早期阶段，我参考并使用了该项目的代码；同时，它也引导我发现了 Calftrail Touch 项目。
- [Gifski](https://github.com/sindresorhus/Gifski) —— 极大地启发了 Mac Mouse Fix [Readme.md](Readme.md) 文档的设计与内容排版。
- [Vue Issue Helper](https://new-issue.vuejs.org/) —— 为 [Mac Mouse Fix 反馈助手](https://noah-nuebling.github.io/mac-mouse-fix-feedback-assistant/) 的设计与技术实现奠定了基础。
