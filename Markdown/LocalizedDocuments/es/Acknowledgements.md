...
Muchas gracias a todos los que utilizan Mac Mouse Fix y brindan comentarios. Es increíble y muy motivador ver a tanta gente disfrutar e interactuar con algo que he creado.

Quiero agradecer especialmente a las personas y proyectos nombrados en este documento.

<a name="translations"></a> 
## 🌏 Traducciones

¡Gracias por llevar Mac Mouse Fix a personas de todo el mundo!
...
- 🇨🇳 Chinese translations by 
  ...
  - 🇰🇷 Traducciones al coreano por [@jeongtae](https://github.com/jeongtae)
  - 🇻🇳 Traducciones al vietnamita por [@nghlt](https://github.com/nghlt)
- 🇧🇷 Brazilian Portuguese translations by 
    - **Eduardo Rodrigues**
    - [@denini08](https://github.com/denini08)
  - 🇫🇷 Traducciones al francés por [@DimitriDR](https://github.com/DimitriDR)
...
Muchas gracias a todos los que me invitaron a un batido y a las **40100+** personas que compraron Mac Mouse Fix.
Gracias a ustedes, puedo dedicar mucho tiempo a hacer algo que amo.

Las personas que me apoyaron gastando más del precio estándar en Mac Mouse Fix reciben una mención especial aquí:

<a name="generous-contributors"></a> 
### ⭐️ Contribuyentes generosos
...
### ❤️ Patrocinadores de GitHub

¡**Enormes gracias** a [todos](https://github.com/sponsors/noah-nuebling#sponsors) los que me patrocinan en GitHub! Con suerte, algún día podré abrir esa fábrica de batidos gracias a ustedes. :)

<a name="paypal-donations"></a> 
### ✨ Donaciones por PayPal

Mucha gente generosa me compró batidos en PayPal cuando Mac Mouse Fix todavía era completamente gratuito.

Si eres uno de ellos, haz clic [aquí](https://redirect.macmousefix.com/?locale=es&target=mmf-apply-for-milkshake-license) para recibir una **licencia gratuita**!
<!-- It's truly incredibly helpful to have some predictable monthly income. -->

<a name="other-software"></a> 
## 👾 Otro software

**Software** que inspiró Mac Mouse Fix:

  - [SteerMouse](https://plentycom.jp/en/steermouse/index.html) - Software pionero para ratones en Mac, que inspiró muchas funciones. Hubo momentos en los que pensé "esto probablemente no es posible", pero luego vi "oh, SteerMouse lo hace", y tres años después, también descubrí cómo implementarlo.
  - [Calftrail Touch](https://github.com/calftrail/Touch) - La base para el trabajo de "ingeniería inversa" que impulsa la mejor simulación de trackpad y la primera en su tipo de Mac Mouse Fix.
  - [MOS](https://mos.caldis.me/) - La opción de "Alta fluidez de desplazamiento" de Mac Mouse Fix, la implementación de "Ajustes específicos de la aplicación" y más, fueron inspiradas por MOS.
  - [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) - Copié su código para una implementación temprana de la función "Volver/Avanzar una página en Safari y otras aplicaciones", y también me llevó a descubrir el proyecto Calftrail Touch.
  - [Gifski](https://github.com/sindresorhus/Gifski) - Inspiró enormemente el diseño y el contenido del [Readme.md](Readme.md) para Mac Mouse Fix.
  - [Vue Issue Helper](https://new-issue.vuejs.org/) - Base para el diseño y la implementación técnica del [Asistente de comentarios de Mac Mouse Fix](https://noah-nuebling.github.io/mac-mouse-fix-feedback-assistant/).
