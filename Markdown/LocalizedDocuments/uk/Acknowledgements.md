...
Документ перекладено на `95%` мовою `🇺🇦 Українська`
[Долучайтеся до перекладу](https://redirect.macmousefix.com/?locale=uk&target=mmf-localization-contribution)</td></table>
...
Велика подяка всім, хто використовує Mac Mouse Fix та надає зворотній зв'язок. Це чудово і дуже мотивує бачити, як стільки багато людей насолоджуються і займаються тим, що я створив.

Я хочу особливо подякувати людям та проєктам, названим у цьому документі.

<a name="translations"></a> 
## 🌏 Переклади

Дякуємо, що допомагаєте людям з усього світу відкрити для себе Mac Mouse Fix!

- 🇨🇳 Китайська:
    - [@groverlynn](https://github.com/groverlynn)
    - [@Dro9an](https://github.com/Dro9an) (Переклад Сайту)
    - [@jihao](https://github.com/jihao) (Переклад Сайту)
    - [@xianyu-wang](https://github.com/xianyu-wang)
    - [@djzhao627](https://github.com/djzhao627)
    - [@JunhangWu](https://github.com/JunhangWu)
- 🇰🇷 Корейська: [@jeongtae](https://github.com/jeongtae)
- 🇻🇳 В'єтнамська: 
...
- 🇨🇿 Чеська: [Petr Pavlík](http://www.petrpavlik.com)
- 🇷🇺 російська: [ETMH](https://t.me/sos_soon_ok)
- 🇪🇸 Іспанська: [@manghidev](https://github.com/manghidev)
- 🇵🇱 Польська: **Jakub** (Переклад Сайту)
...
<!-- 
  ...
  Thanks so much to everyone who bought me a milkshake and to all 48500+ people who bought Mac Mouse Fix! Ya'll are the bomb. Thanks to you I can spend lots of time on sth I love doing.
...
Велике Дякую всім, хто пригостив мене Мілкшейком і всім **48500+** людям, які купили Mac Mouse Fix.
Дякую Тобі, що я можу витрачати багато часу роблячи те, що люблю. 

Люди, які підтримали мене, витративши більше, ніж стандартна ціна на Mac Mouse Fix, отримують особливу згадку тут:
...
**Великі подяки** для [всіх](https://github.com/sponsors/noah-nuebling#sponsors) хто є спонсором на GitHub! Сподіваюся, одного дня я зможу отримати цю фабрику мілкшейків завдяки Вам. :)

<a name="paypal-donations"></a> 
### ✨ PayPal Донати

Багато щедрих людей купили мені мілкшейки на PayPal поки Mac Mouse Fix була повністю безплатна.

Якщо ви є серед них, клацніть [тут](https://redirect.macmousefix.com/?locale=uk&target=mmf-apply-for-milkshake-license) щоб отримати **безплатну ліцензію**!
<!-- It's truly incredibly helpful to have some predictable monthly income. -->

<a name="other-software"></a> 
## 👾 Інші Програми

**Програми** що надихнули Mac Mouse Fix:

- [SteerMouse](https://plentycom.jp/en/steermouse/index.html) - Новаторська програма для мишей на Mac, що надихнуло на багато функцій. Були моменти, коли я думав, що 'це, напевно, неможливо', але потім я побачив, що SteerMouse це робить, і за три роки я теж знайшов спосіб це реалізувати.
- [Calftrail Touch](https://github.com/calftrail/Touch) - Основа для 'реверс-інжинірингу', завдяки якому працює найкраща у своєму класі та перша у своєму роді симуляція трекпеда в Mac Mouse Fix!
- [MOS](https://mos.caldis.me/) - Параметр 'Висока плавність прокрутки', реалізація параметрів для окремих програм та багато іншого були натхненні MOS.
- [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) - Я скопіював цей код для ранньої реалізації функції 'Перехід на одну сторінку назад/вперед у Safari та інших програмах', що також допомогло мені відкрити проєкт Calftrail Touch.
- [Gifski](https://github.com/sindresorhus/Gifski) - Неабияк надихнув на дизайн та вміст файлу [Readme.md](Readme.md) для Mac Mouse Fix.
- [Vue Issue Helper](https://new-issue.vuejs.org/) - Основа для дизайну та технічної реалізації [Mac Mouse Fix Feedback Assistant](https://noah-nuebling.github.io/mac-mouse-fix-feedback-assistant/).
