...
Допомога з проблемами та запитаннями щодо Mac Mouse Fix.

## Запитання

Швидкі відповіді на поширені запитання [тут](<../Readme.md#questions>).

## Посібники

Ми намагаємося зробити Mac Mouse Fix максимально зрозумілим на інтуїтивному рівні. Проте для деяких речей стануть у пригоді детальніші пояснення:

- [Коліщатко захоплене](<../Support/Guides/CapturedScrollWheels.md>)
- [Кнопки миші захоплені](<../Support/Guides/CapturedButtonsMMF3.md>) (Mac Mouse Fix 3)
- [Captured Mouse Buttons](<../../../../Support/Guides/CapturedButtonsMMF2.md>) (Mac Mouse Fix 2) `🇬🇧 English`

### Старіші Посібники

Посібники для старіших версій Mac Mouse Fix чи macOS.

- [Enabling Mac Mouse Fix](<../../../../Support/Guides/Old/Enabling.md>) `🇬🇧 English`
    - Для **macOS 13 Ventura** і **macOS 14 Sonoma**.
- [Granting Accessibility Access](<../../../../Support/Guides/Old/AccessibilityAccess.md>) `🇬🇧 English`
    - Для користувачів **Mac Mouse Fix 2.2.1** і старіше, чи **macOS 10.14 Mojave** і старіше.
- [Opening Mac Mouse Fix & Malware Messages](<../../../../Support/Guides/Old/Opening.md>) `🇬🇧 English`
    - Для **Mac Mouse Fix 2.2.3** і старіше.

## Контакт

Досі маєте запитання? Клацніть [тут](https://redirect.macmousefix.com/?locale=uk&target=mmf-support-still-have-questions).
