...
Dieses Dokument ist zu `95%` übersetzt auf `🇩🇪 Deutsch`
...
- 🇻🇳 Vietnamesische Übersetzungen von 
...
- 🇪🇸 Spanische Übersetzungen von [@manghidev](https://github.com/manghidev)
- 🇵🇱 Polische Übersetzungen von **Jakub** (Website Übersetzung)
...
Vielen Dank an alle, die mir einen Milchshake spendiert haben, und an alle **48500+** Personen, die Mac Mouse Fix gekauft haben.
