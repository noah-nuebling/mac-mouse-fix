**Nota para Usuários do Mac Mouse Fix 2**
...
Mac Mouse Fix **3.0.3** está pronto para macOS 15 Sequoia. Também corrige alguns problemas de estabilidade e traz várias pequenas melhorias.
...
Na versão 3.0.2, fiz mudanças na forma como o Mac Mouse Fix envia eventos de rolagem para o sistema, tentando reduzir travamentos provavelmente causados por problemas com as APIs VSync da Apple.
...
- Várias melhorias e limpezas menores no código interno.
